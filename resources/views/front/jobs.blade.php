                                ...
                                <div class="col-md-4">
                                    <div class="card border-0 p-3 shadow mb-4">
                                        <div class="card-body">
                                            ...
                                            <p id="text-description-width">{{ Str::words(strip_tags ($job->description), $words=1, '...') }}</p>
                                            
                                            <div class="bg-light p-3 border">
                                                <p class="mb-0">
                                                    <span class="fw-bolder"><i class="fa-solid fa-location-dot"></i></i></span>
                                                ...
                                                <p class="mb-0">    
                                                    <span class="fw-bolder"><i class="fa-solid fa-paperclip"></i></span>
