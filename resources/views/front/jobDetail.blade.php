                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($application->user->cv)
                                                    <a href="{{ asset('cv/'.$application->user->cv) }}" class="btn btn-sm btn-primary" download><i class="fa-solid fa-file-pdf"></i></a>
                                                @else
                                                    <span class="text-muted"><i class="fa-solid fa-x"></i></span>
                                                @endif
                                            </td>
                                        </tr>
                                        @endforeach
