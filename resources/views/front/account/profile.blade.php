                ...
                <div class="col-lg-9">
                    ...
                    <div class="card border-0 shadow mb-4">
                        ...
                        <div class="card-body  p-4">
                            ...
                            <div class="mb-4">
                                <label for="" class="mb-2">CV (PDF)</label>
                                <input type="file" name="cv" id="cv" accept=".pdf" 
                                    class="form-control">
                                @if($user->cv)
                                    <div class="mt-2">
                                        <p class="text-muted">Uploaded CV: {{ $user->cv }}</p>
                                        <div class="d-flex gap-2">
                                            <a href="{{ asset('cv/'.$user->cv) }}" class="btn btn-primary btn-sm" download>
                                                Download CV
                                            </a>
                                            <button type="button" onclick="deleteCV()" class="btn btn-danger btn-sm">
                                                Delete CV
                                            </button>
                                        </div>
                                    </div>
